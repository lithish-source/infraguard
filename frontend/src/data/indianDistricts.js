/**
 * Updated Indian States and Union Territories with Districts.
 * Verified to have zero duplicate district names across all states/UTs.
 */
...
export function getDistrictsForState(state) {
  if (!state || !INDIAN_STATES_AND_DISTRICTS[state]) return [];
